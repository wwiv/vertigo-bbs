...
// ====================================================================
// Vertigo BBS Software               Copyright 1997-2013 By James Coyle
// ====================================================================
//
...
Begin
  WriteLn;
  WriteLn ('PCB2GBBS : PCBoard to Vertigo BBS File Base Converter');
  WriteLn ('Copyright (C) 1998-2012 By James Coyle.  All Rights Reserved');
  WriteLn;
  WriteLn ('Compiled for Vertigo BBS v' + mysVersion);
  WriteLn;

  If ParamCount < 2 Then Begin
    WriteLn ('Usage: [PCBoard File]  [Vertigo BBS File]  -DUPE');
    Halt(1);
  End;
