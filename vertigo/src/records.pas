...

{
 ...
 Desc    | This file holds the data file records for all data files used
           within Vertigo BBS software.  Vertigo BBS is compiled with the
...
Type
 ...
 // SYSTEM PATHS
    SystemPath      : String[mysMaxPathSize];                   // Root vertigo path
...
(* Each record of VOTES.DAT is one question.  Vertigo only allows for up *)
(* to 20 questions. *)
