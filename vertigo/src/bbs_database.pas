...
Begin
  ...
  If Not FileExist('vertigo.dat') And UseEnv Then
    If GetENV('vertigobbs') <> '' Then
      bbsCfgPath := DirSlash(GetENV('vertigobbs'));

  Assign (TempFile, bbsCfgPath + 'vertigo.dat');
...
Begin
  ...
  // PKT filename format used by Vertigo:
