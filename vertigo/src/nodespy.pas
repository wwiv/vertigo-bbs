...
Begin
  ...
  If IoResult <> 0 Then Begin
    ...
    If IoResult <> 0 Then Begin
      Screen.WriteLine ('ERROR: Unable to read VERTIGO.DAT' + #13#10);
      Screen.WriteLine ('VERTIGO.DAT must exist in the same directory as NodeSpy, or in the');
      Screen.WriteLine ('path defined by the VERTIGOBBS environment variable.');
