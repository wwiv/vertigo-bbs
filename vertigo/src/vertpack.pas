...
// Vertigo BBS Softwara              Copyright 2017 Andrew Pamment
// ====================================================================
//
...
Begin
  ...
  PWriteLn ('|08-> |07Compatible with Vertigo BBS software v' + mysVersion);
  ...
  If IoResult <> 0 Then Begin
    WriteLn ('ERROR: Unable to read VERTIGO.DAT.  Run from root Vertigo directory');
    Halt(1);
  End;
